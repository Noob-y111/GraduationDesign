...
//        searchBoxWidth()
    ...
    private fun initContainer(){
        ...
        val fixFragmentNavigator = FixFragmentNavigator(this, container.childFragmentManager, R.id.main_container)
    ...
    private fun initNavGraph(provider: NavigatorProvider, fixFragmentNavigator: FixFragmentNavigator): NavGraph{
